...
import ru.mirea.practice22.models.Product;
import ru.mirea.practice22.repositories.MarketRepository;
import ru.mirea.practice22.repositories.ProductRepository;
...
public class ProductService {
    ...
    public void save(Product product, int marketId) {
        ...
        emailService.sendEmail("Save Product", product.getName());
    }
